...
void TestServer::initialise()
{
   ...
   //Example adding an array by setting it with setArrayCopy
    opc::NodeId setArrayCopy_array_id(_idx, "Array_By_Copy");
    UA_Double setArrayCopy_temp_array[4] = {1.0, 2.0, 3.0, 4.0};
    const size_t array_size = 4;
    opc::Variant setArrayCopy_variant;
    setArrayCopy_variant.setArrayCopy(&setArrayCopy_temp_array, array_size, &UA_TYPES[UA_TYPES_DOUBLE]);
    addVariable(opc::NodeId::Objects, "Array_By_Copy", setArrayCopy_variant , setArrayCopy_array_id, opc::NodeId::Null);

    //Example adding an array by setting it with setArray as a child for Array_With_Copy
    opc::NodeId setArray_array_id(_idx, "Array_By_Set");
    opc::Variant setArray_variant;
    ...
    addVariable(setArrayCopy_array_id, "Array_By_Set", setArray_variant , setArray_array_id, opc::NodeId::Null);

    //Example adding a matrix 
    opc::NodeId test_matrix_id(_idx, "Matrix_Example");
    opc::VariableAttributes vattr;
    opc::Variant vattr_value;
    ...
    addVariable(opc::NodeId::Objects, "Matrix_Example", vattr_value, test_matrix_id, opc::NodeId::Null);
