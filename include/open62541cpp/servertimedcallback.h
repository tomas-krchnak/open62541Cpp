    ...
    class  UA_EXPORT  ServerTimedCallback {
        ...
        public:
            ...
            */
             ...
             * \param i
             */
            void setInterval(UA_DateTime i)
            {
                _interval = i;
            }
            /*!
             ...
             * \param i
             */
            void addSeconds(unsigned i)
            {
                _interval += (i * UA_DATETIME_SEC);
            }
            /*!
             * \brief addMilliSeconds
             * \param i
             */
            void addMilliSeconds(unsigned i)
            {
                _interval += (i * UA_DATETIME_MSEC);
            }
    };
    /*!
